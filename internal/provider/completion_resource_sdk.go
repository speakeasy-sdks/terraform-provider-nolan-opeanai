...
func (r *CompletionResourceModel) RefreshFromCreateResponse(resp *shared.CreateCompletionResponse) {
	...
	for _, choicesItem := range resp.Choices {
		...
		// Not Implemented choicesItem.Logprobs.TokenLogprobs, {"Type":"array","BaseName":"","RefType":"","Input":false,"Scope":"","Format":"","Name":"","ItemType":{"AssociatedTypes":[],"BaseName":"","Truncated":false,"Comments":null,"Input":false,"Extensions":{"x-speakeasy-param-readonly":true,"x-speakeasy-param-computed":true,"x-speakeasy-param-force-new":true,"Symbol":"TokenLogprobs"},"Fields":[],"ItemType":null,"Scope":"","Output":false,"Examples":[],"Discriminator":null,"Type":"number","Enum":null,"RefType":"","Format":"","AdditionalProperties":null,"Name":""},"AssociatedTypes":[],"Enum":null,"Truncated":false,"Output":false,"Fields":[],"Comments":null,"Extensions":{"x-speakeasy-param-computed":true,"x-speakeasy-param-force-new":true,"x-speakeasy-param-readonly":true},"Examples":[],"AdditionalProperties":null,"Discriminator":null}, true, , , choices1.Logprobs.TokenLogprobs
